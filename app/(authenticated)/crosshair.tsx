...
const CROSSHAIR_DB: CrosshairData[] = [
  {
    ...
    tags: ["Cyan", "Standard"],
    style: { type: "cross", color: "#00FFFF", thickness: 2, gap: 2 },
  },
  {
    name: "Yay",
    team: "BLD",
    ...
    tags: ["White", "Cross"],
    style: { type: "cross", color: "#FFFFFF", thickness: 2, gap: 0 },
  },
  {
    name: "ScreaM",
    team: "KC",
    category: "Pro",
    code: "0;P;c;5;o;1;d;1;z;3;f;0;0t;6;0l;0;0a;1;0f;0;1b;0",
    tags: ["Cyan", "Dot"],
    style: { type: "dot", color: "#00FFFF", thickness: 4 },
  },
  {
    name: "Boaster",
    team: "FNC",
    ...
    tags: ["Green", "Box"],
    style: { type: "box", color: "#00FF00", thickness: 2 },
  },
  {
    name: "Demon1",
    team: "NRG",
    ...
    tags: ["White", "Dot"],
    style: { type: "dot", color: "#FFFFFF", thickness: 3 },
  },
  {
    name: "Aspas",
    team: "LEV",
    ...
    tags: ["Cyan", "Small"],
    style: { type: "cross", color: "#00FFFF", thickness: 1, gap: 0 },
  },
  {
    name: "Grim",
    team: "CONTENT",
    category: "Content",
    code: "0;p;0;s;1;P;c;5;u;000000FF;h;0;f;0;0l;4;0v;4;0g;1;0o;2;0a;1;0f;0;1b;0",
    tags: ["Grim Wall", "Line"],
    style: { type: "cross", color: "#FF0000", thickness: 1, gap: 4 },
  },
  {
    name: "Smiley",
    team: "FUN",
    category: "Fun",
    code: "0;P;c;8;u;FF0000FF;h;0;d;1;b;1;z;3;0t;10;0l;2;0v;0;0g;1;0o;4;0a;1;0f;0;1t;1;1l;0;1v;4;1g;1;1o;0;1a;1;1m;0;1f;0",
    tags: ["Troll", "Face"],
    style: { type: "circle", color: "#FFA500" },
  },
];
  ...
  return (
    <View style={center}>
      <View
        style={[
          tickStyle,
          { width: thickness, height: length, top: 20 - offset - length / 2 },
        ]}
      />
      <View
        style={[
      ...
      <View
        style={[
          tickStyle,
          { height: thickness, width: length, left: 20 - offset - length / 2 },
        ]}
      />
      <View
        style={[
      ...
      <View style={styles.previewHeader}>
        <View style={styles.previewContent}>
          ...
          <View style={styles.previewInfo}>
            ...
            <Text style={styles.previewTeam}>
              {selected.team} - {selected.category}
            </Text>
          </View>
        </View>
      </View>
                ...
                <GlassCard style={[styles.card, isSelected && styles.cardSelected]}>
                  ...
                  <View style={styles.miniPreview}>
                    <CrosshairRender
                      style={{
                        ...item.style,
                        color: isSelected ? item.style.color : "#9b958d",
                      }}
                    />
                  </View>
